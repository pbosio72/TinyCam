...
static esp_err_t index_handler(httpd_req_t *req) {
  const char* html = 
    ...
    "<br>"
    "<button class='rotate' onclick='setRotation(\"vflip\")'>FLIP VERTICAL</button>"
    "<button class='rotate' onclick='setRotation(\"hmirror\")'>FLIP HORIZONTAL</button>"
    "</div>"
    ...
    "<div class='info'>Auto-refresh: 100ms</div>"
    ...
    "}"
    "refreshInterval = setInterval(updateImage, 100);"
